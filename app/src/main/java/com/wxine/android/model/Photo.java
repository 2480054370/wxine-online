...
public class Photo implements java.io.Serializable {
	...
	/** minimal constructor */
	public Photo(String id, String name, String url, User user, Timestamp ctime) {
		this.id = id;
		this.name = name;
		this.url = url;
		this.user = user;
	...
	/** full constructor */
	public Photo(String id, User user, Syscate syscate, Usercate usercate, Community community, Event event,
